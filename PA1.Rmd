...
```
Interval with the hightest average step count: Interval `r maxinterval`
...
The mean steps with imputed data is roughly `r round(meansteps/imputed_meansteps *100 - 100) ` percent lower than the unimputed mean. The imputed median is about `r round(imputed_mediansteps/mediansteps *100 - 100)` percent lower than the unimputed median.
